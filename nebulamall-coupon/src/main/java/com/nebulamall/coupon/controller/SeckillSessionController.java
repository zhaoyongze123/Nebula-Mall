...
import com.nebulamall.coupon.service.SeckillSessionService;
...
public class SeckillSessionController {
    ...
    public R info(@PathVariable("id") Long id){
		SeckillSessionEntity smsSeckillSession = smsSeckillSessionService.getById(id);
    ...
    public R save(@RequestBody SeckillSessionEntity smsSeckillSession){
    ...
    public R update(@RequestBody SeckillSessionEntity smsSeckillSession){
