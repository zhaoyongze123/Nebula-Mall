...
import com.nebulamall.coupon.entity.SkuFullReductionEntity;
import com.nebulamall.coupon.service.SkuFullReductionService;
...
public class SkuFullReductionController {
    ...
    public R info(@PathVariable("id") Long id){
		SkuFullReductionEntity smsSkuFullReduction = smsSkuFullReductionService.getById(id);
    ...
    public R save(@RequestBody SkuFullReductionEntity smsSkuFullReduction){
    ...
    public R update(@RequestBody SkuFullReductionEntity smsSkuFullReduction){
